export const errors = {
  ...
  forbidden_action: "Voce nao tem permissao para {{action}} este(a) {{resource}}",
  ...
  jwt_secret_not_configured: "A variavel de ambiente JWT_SECRET nao esta configurada",
  ...
  db_error_adding_item: "Erro do banco de dados ao adicionar item ao(a) {{resource}}",
  db_error_deleting_item: "Erro do banco de dados ao remover item do(a) {{resource}}",
  db_error_updating_item: "Erro do banco de dados ao atualizar item do(a) {{resource}}",
  db_error_getting_items: "Erro do banco de dados ao buscar itens do(a) {{resource}}",
  ...
  tenant_not_found_for_subscription: "Nenhum inquilino encontrado para a assinatura {{subscription_id}}",
} as const;

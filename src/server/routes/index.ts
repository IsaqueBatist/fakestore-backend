...
router.get(
  "/products/:id/detail",
  ProductController.getDetailValidation,
...
router.post(
  ...
  ensureAuthenticated,
  ensureAdmin,
  ProductController.addDetailValidation,
...
router.delete(
  ...
  ensureAuthenticated,
  ensureAdmin,
  ProductController.deleteDetailValidation,
...
router.put(
  ...
  ensureAuthenticated,
  ensureAdmin,
  ProductController.updateDetailValidation,
